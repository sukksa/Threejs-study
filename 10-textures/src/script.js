...
// colorTexture.repeat.x = 2 // 水平方向重复两次
// colorTexture.repeat.y = 3 // 垂直方向重复三次
// colorTexture.wrapS = THREE.RepeatWrapping // 水平方向重复
// colorTexture.wrapT = THREE.MirroredRepeatWrapping // 垂直方向镜像重复 

// colorTexture.offset.x = 0.5 // x轴偏移0.5
// colorTexture.offset.y = 0.5 // y轴偏移0.5

// colorTexture.rotation = Math.PI / 4 // 旋转45度
// // 旋转中心点 默认(0,0) 左下角
